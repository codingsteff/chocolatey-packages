...
[![](https://ci.appveyor.com/api/projects/status/r3tg6hf53jli0bid?svg=true)](https://ci.appveyor.com/project/codingsteff/chocolatey-packages/build/$Env:APPVEYOR_BUILD_NUMBER)
...
_This file is automatically generated by the [update_all.ps1](https://github.com/codingsteff/chocolatey-packages/blob/master/update_all.ps1) script using the [AU module](https://github.com/majkinetor/au) ( [view source](https://github.com/codingsteff/chocolatey-packages/blob/master/gist.md.ps1) )._

|||
|---               | --- |
**Time (UTC)**     | $($Info.startTime.ToUniversalTime().ToString('yyyy-MM-dd HH:mm'))
**Git repository** | https://github.com/codingsteff/chocolatey-packages
